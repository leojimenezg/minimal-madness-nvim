...
vim.api.nvim_set_hl(0, "@type.builtin", { fg = colors.light_grey })
...
vim.api.nvim_set_hl(0, "StatusLine", { fg = colors.light_grey, bg = colors.bg })
vim.api.nvim_set_hl(0, "StatusLineNC", { fg = colors.grey, bg = colors.bg })
